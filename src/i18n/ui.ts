...
export const ui = {
	en: {
		...
		"projects.see": "View More",
		"hero.title.main": "I create",
		"hero.title.1": "website",
		"hero.title.2": "design",
		"hero.title.3": "website",
		"hero.title.4": "design",
		"hero.subtitle": "我是惠晴，目前是一名網站前端工程師。",
		"hero.subtitle.2": "在網站設計領域已有一年半，點擊按鈕觀看更多專案作品。",
		...
		"contact.send": "mail me",
		"blog.title": "blog",
		"blog.subtitle": "To see more projects here!",
